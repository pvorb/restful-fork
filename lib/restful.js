...
var director = require('director'),
    ...
    utile    = require('utile'),
    http     = require('http'),
    defaultMakeRequest = require('./makeRequest.js');

exports.makeRequest = defaultMakeRequest;
...
exports.extendRouter = function (router, resources, options, respond) {
  ...
  router.path(options.prefix, function() {
    ...
    _extend(this, resources, options, makeRequest, respond);
  })
};

function _extend (router, resources, options, makeRequest, respond, routeInfo) {
    ...
    router.path(entity, function () {
      ...
      this.get(function () {
        ...
        if (options.parent) {
          ...
          makeRequest['show all'](resource, req, showHandler);
      ...
      this.post(function () {
        ...
        makeRequest['create'](resource, req, createHandler);
      ...
      this.path('/' + param, function () {
        ...
        if (resource._children && resource._children.length > 0) {
          ...
          resource._children.forEach(function(child){
            ...
            _extend(paramScopedRouter, childResource, clonedOptions, makeRequest, respond, childRouteInfo);
          });
        }
        ...
        this.post(function () {
          ...
          makeRequest['create'](resource, req, respond);
        });
        ...
        this.get(function () {
          ...
          makeRequest['show'](resource, req, handler);
        });
