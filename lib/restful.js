...
exports.extendRouter = function (router, resources, options, respond) {
  ...
  var getQuery = options.getQuery || defaultGetQuery;
  var getFields = options.getFields || defaultGetFields;
  var getOptions= options.getOptions || defaultGetOptions;
  respond = respond || options.respond || respondWithResult;
  ...
  router.path(options.prefix, function() {
    ...
    _extend(this, resources, options, getQuery, getFields, getOptions, respond);
  })
};

function _extend(router, resources, options, getQuery, getFields, getOptions,
    respond, routeInfo) {
  ...
  resources.forEach(function (resource) {
    ...
    router.path(entity, function () {
      ...
      this.post(function () {
        ...
        // convention,
        // so we might as well try to conform to that unless there is a better
        // solution.
        //
...
function defaultGetQuery(action, req, id) {
  if (typeof id == 'undefined')
    return {};
  return { _id: id };
}

function defaultGetFields(action, req) {
  return {};
}

function defaultGetOptions(action, req) {
  return {};
}
